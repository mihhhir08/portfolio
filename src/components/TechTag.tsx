...
export default function TechTag({ name }: { name: string }) {
  ...
  return (
    <span className="inline-flex items-center gap-1.5 rounded-full border border-hairline bg-bg/40 px-3 py-1 font-mono text-xs text-muted transition-all duration-200 hover:-translate-y-0.5 hover:border-hairline-bright hover:text-fg">
      {icon && (
        <svg
          width="13"
          height="13"
